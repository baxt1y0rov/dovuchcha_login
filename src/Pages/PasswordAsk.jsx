...
export default function PasswordAsk() {
  return (
    <div style={containerStyle}>
      <div style={cardStyle}className='card'>
        ...
        <div style={{marginBottom: '1.5rem'}}>
          <h1 className='signintext'style={{fontSize: '2em', color: 'white', marginBottom:0}}>Create a strong password</h1>
          <p style={{fontSize: '1rem', fontWeight:400,color: '#E5F4D8',marginBlockEnd:40}}>Create a strong password with a mix of letters, numbers and symbols
          </p>
        </div>
        ...
        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <Link className='button' to='/SucceedAcc' style={buttonStyle}>Next</Link>
        </div>
      </div>
